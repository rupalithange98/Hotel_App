...
import RoomBooking from './HotelDetail/Booking';
...
export function RoomView(props) {
  ...
  // let hotelId=props.match.params.id
  // console.log(hotelId)
    ...
    useEffect(() => {
        ...
        // const hotelDetails = hotelData.filter((Hotel) =>console.log("Json hotel Id:",Hotel.id))
